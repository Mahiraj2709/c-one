angular.module('starter')
    .controller('ProfileCtrl', function ($scope, $http, $rootScope, $ionicLoading, $ionicPopup, $cordovaCamera,
                                         UploadImageService,
        ...
        $scope.videoChooser = function () {
            $scope.videoPopup = $ionicPopup.show({
                templateUrl: 'views/dialog/video_select_dialog.html',
                scope: $scope,
            });
        }
        ...
        $scope.showVideo = function () {
            //$scope.videoPopup.close()
            services.petProfileVideo(function (resposne) {
                if (resposne.response_status == 1) {
                    $scope.videoPopup.close()

                    if(resposne.response_data.profile.length == 0) {
                        popups.showAlert('You have not uploaded any video!');return
                    }
